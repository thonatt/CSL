...
class Sampler : public NamedObject<Sampler<aType,nType,N,sType,isArray,isShadow>> {
public:
	...
	Sampler(const std::string & s = "") : NamedObject<Sampler>(s) {
...
using sampler1DArray = Sampler < SAMPLER, FLOAT, 1, BASIC, ARRAY >;
using sampler2DArray = Sampler < SAMPLER, FLOAT, 2, BASIC, ARRAY >;
using samplerBuffer = Sampler < SAMPLER, FLOAT, 0, BUFFER >;
using sampler2DMS = Sampler < SAMPLER, FLOAT, 2, MULTI_SAMPLE >;
using sampler2DMSArray = Sampler < SAMPLER, FLOAT, 2, MULTI_SAMPLE, ARRAY>;
using samplerCubeArray = Sampler < SAMPLER, FLOAT, 0, CUBE, ARRAY >;
using sampler1DShadow = Sampler < SAMPLER, FLOAT, 1, BASIC, NOT_ARRAY, SHADOW >;
using sampler2DShadow = Sampler < SAMPLER, FLOAT, 2, BASIC, NOT_ARRAY, SHADOW >;
using sampler2DRectShadow = Sampler < SAMPLER, FLOAT, 2, RECTANGLE, NOT_ARRAY, SHADOW>;
using sampler1DArrayShadow = Sampler < SAMPLER, FLOAT, 1, BASIC, ARRAY, SHADOW >;
using sampler2DArrayShadow = Sampler < SAMPLER, FLOAT, 2, BASIC, ARRAY, SHADOW >;
using samplerCubeShadow = Sampler < SAMPLER, FLOAT, 0, CUBE, NOT_ARRAY, SHADOW >;
using samplerCubeArrayShadow = Sampler < SAMPLER, FLOAT, 0, CUBE, ARRAY, SHADOW >;
...
using isampler1DArray = Sampler < SAMPLER, INT, 1, BASIC, ARRAY >;
using isampler2DArray = Sampler < SAMPLER, INT, 2, BASIC, ARRAY >;
using isamplerBuffer = Sampler < SAMPLER, INT, 0, BUFFER >;
using isampler2DMS = Sampler < SAMPLER, INT, 2, MULTI_SAMPLE >;
using isampler2DMSArray = Sampler < SAMPLER, INT, 2, MULTI_SAMPLE, ARRAY>;
using isamplerCubeArray = Sampler < SAMPLER, INT, 0, CUBE, ARRAY >;
...
using usampler1DArray = Sampler < SAMPLER, UINT, 1, BASIC, ARRAY >;
using usampler2DArray = Sampler < SAMPLER, UINT, 2, BASIC, ARRAY >;
using usamplerBuffer = Sampler < SAMPLER, UINT, 0, BUFFER >;
using usampler2DMS = Sampler < SAMPLER, UINT, 2, MULTI_SAMPLE >;
using usampler2DMSArray = Sampler < SAMPLER, UINT, 2, MULTI_SAMPLE, ARRAY>;
using usamplerCubeArray = Sampler < SAMPLER, UINT, 0, CUBE, ARRAY >;
...
using image1DArray = Sampler < IMAGE, FLOAT, 1, BASIC, ARRAY >;
using image2DArray = Sampler < IMAGE, FLOAT, 2, BASIC, ARRAY >;
using imageBuffer = Sampler < IMAGE, FLOAT, 0, BUFFER >;
using image2DMS = Sampler < IMAGE, FLOAT, 2, MULTI_SAMPLE >;
using image2DMSArray = Sampler < IMAGE, FLOAT, 2, MULTI_SAMPLE, ARRAY>;
using imageCubeArray = Sampler < IMAGE, FLOAT, 0, CUBE, ARRAY >;
...
using iimage1DArray = Sampler < IMAGE, INT, 1, BASIC, ARRAY >;
using iimage2DArray = Sampler < IMAGE, INT, 2, BASIC, ARRAY >;
using iimageBuffer = Sampler < IMAGE, INT, 0, BUFFER >;
using iimage2DMS = Sampler < IMAGE, INT, 2, MULTI_SAMPLE >;
using iimage2DMSArray = Sampler < IMAGE, INT, 2, MULTI_SAMPLE, ARRAY>;
using iimageCubeArray = Sampler < IMAGE, INT, 0, CUBE, ARRAY >;
...
using uimage1DArray = Sampler < IMAGE, UINT, 1, BASIC, ARRAY >;
using uimage2DArray = Sampler < IMAGE, UINT, 2, BASIC, ARRAY >;
using uimageBuffer = Sampler < IMAGE, UINT, 0, BUFFER >;
using uimage2DMS = Sampler < IMAGE, UINT, 2, MULTI_SAMPLE >;
using uimage2DMSArray = Sampler < IMAGE, UINT, 2, MULTI_SAMPLE, ARRAY>;
using uimageCubeArray = Sampler < IMAGE, UINT, 0, CUBE, ARRAY >;
