...
namespace csl {
	...
	namespace core {
		...
		template<AccessType aType, ScalarType nType, uint N, SamplerType sType, SamplerFlags sFlags> // SamplerIsArray isArray, SamplerIsShadow isShadow>
		...
		public:
			...
			Sampler(const std::string & s = "", ObjFlags obj_flags = ObjFlags::NONE)
				: NamedObject<Sampler>(s, obj_flags) {
			}

			Sampler(const std::string& s, OpFlags ctor_flags)
				: NamedObject<Sampler>(s, ctor_flags) {
			}


			Sampler(const Ex & _ex, OpFlags ctor_flags = OpFlags::NONE, ObjFlags obj_flags = ObjFlags::IS_TRACKED, const std::string & s = "")
	...
	using sampler1DArray = core::Sampler < core::SAMPLER, core::FLOAT, 1, core::BASIC, core::SamplerFlags::IS_ARRAY >;
	using sampler2DArray = core::Sampler < core::SAMPLER, core::FLOAT, 2, core::BASIC, core::SamplerFlags::IS_ARRAY >;
	...
	using sampler2DMSArray = core::Sampler < core::SAMPLER, core::FLOAT, 2, core::MULTI_SAMPLE, core::SamplerFlags::IS_ARRAY>;
	using samplerCubeArray = core::Sampler < core::SAMPLER, core::FLOAT, 0, core::CUBE, core::SamplerFlags::IS_ARRAY >;
	using sampler1DShadow = core::Sampler < core::SAMPLER, core::FLOAT, 1, core::BASIC, core::SamplerFlags::IS_SHADOW >;
	using sampler2DShadow = core::Sampler < core::SAMPLER, core::FLOAT, 2, core::BASIC, core::SamplerFlags::IS_SHADOW >;
	using sampler2DRectShadow = core::Sampler < core::SAMPLER, core::FLOAT, 2, core::RECTANGLE, core::SamplerFlags::IS_SHADOW>;
	using sampler1DArrayShadow = core::Sampler < core::SAMPLER, core::FLOAT, 1, core::BASIC, core::SamplerFlags::IS_ARRAY | core::SamplerFlags::IS_SHADOW >;
	using sampler2DArrayShadow = core::Sampler < core::SAMPLER, core::FLOAT, 2, core::BASIC, core::SamplerFlags::IS_ARRAY | core::SamplerFlags::IS_SHADOW >;
	using samplerCubeShadow = core::Sampler < core::SAMPLER, core::FLOAT, 0, core::CUBE, core::SamplerFlags::IS_SHADOW >;
	using samplerCubeArrayShadow = core::Sampler < core::SAMPLER, core::FLOAT, 0, core::CUBE, core::SamplerFlags::IS_ARRAY | core::SamplerFlags::IS_SHADOW >;
	...
	using isampler1DArray = core::Sampler < core::SAMPLER, core::INT, 1, core::BASIC, core::SamplerFlags::IS_ARRAY >;
	using isampler2DArray = core::Sampler < core::SAMPLER, core::INT, 2, core::BASIC, core::SamplerFlags::IS_ARRAY >;
	...
	using isampler2DMSArray = core::Sampler < core::SAMPLER, core::INT, 2, core::MULTI_SAMPLE, core::SamplerFlags::IS_ARRAY >;
	using isamplerCubeArray = core::Sampler < core::SAMPLER, core::INT, 0, core::CUBE, core::SamplerFlags::IS_ARRAY >;
	...
	using usampler1DArray = core::Sampler < core::SAMPLER, core::UINT, 1, core::BASIC, core::SamplerFlags::IS_ARRAY >;
	using usampler2DArray = core::Sampler < core::SAMPLER, core::UINT, 2, core::BASIC, core::SamplerFlags::IS_ARRAY >;
	...
	using usampler2DMSArray = core::Sampler < core::SAMPLER, core::UINT, 2, core::MULTI_SAMPLE, core::SamplerFlags::IS_ARRAY >;
	using usamplerCubeArray = core::Sampler < core::SAMPLER, core::UINT, 0, core::CUBE, core::SamplerFlags::IS_ARRAY >;
	...
	using image1DArray = core::Sampler < core::IMAGE, core::FLOAT, 1, core::BASIC, core::SamplerFlags::IS_ARRAY >;
	using image2DArray = core::Sampler < core::IMAGE, core::FLOAT, 2, core::BASIC, core::SamplerFlags::IS_ARRAY >;
	...
	using image2DMSArray = core::Sampler < core::IMAGE, core::FLOAT, 2, core::MULTI_SAMPLE, core::SamplerFlags::IS_ARRAY >;
	using imageCubeArray = core::Sampler < core::IMAGE, core::FLOAT, 0, core::CUBE, core::SamplerFlags::IS_ARRAY >;
	...
	using iimage1DArray = core::Sampler < core::IMAGE, core::INT, 1, core::BASIC, core::SamplerFlags::IS_ARRAY >;
	using iimage2DArray = core::Sampler < core::IMAGE, core::INT, 2, core::BASIC, core::SamplerFlags::IS_ARRAY >;
	...
	using iimage2DMSArray = core::Sampler < core::IMAGE, core::INT, 2, core::MULTI_SAMPLE, core::SamplerFlags::IS_ARRAY>;
	using iimageCubeArray = core::Sampler < core::IMAGE, core::INT, 0, core::CUBE, core::SamplerFlags::IS_ARRAY >;
	...
	using uimage1DArray = core::Sampler < core::IMAGE, core::UINT, 1, core::BASIC, core::SamplerFlags::IS_ARRAY >;
	using uimage2DArray = core::Sampler < core::IMAGE, core::UINT, 2, core::BASIC, core::SamplerFlags::IS_ARRAY >;
	...
	using uimage2DMSArray = core::Sampler < core::IMAGE, core::UINT, 2, core::MULTI_SAMPLE, core::SamplerFlags::IS_ARRAY>;
	using uimageCubeArray = core::Sampler < core::IMAGE, core::UINT, 0, core::CUBE, core::SamplerFlags::IS_ARRAY >;
